...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  ...
  var this$7 = new $c_sc_MapOps$WithFilter().init___sc_MapOps__F1(namedExpressions, p);
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$2$1, result$1, namedExpressions$1) {
    return (function(x$1$2) {
      var x$1 = $as_T2(x$1$2);
      if ((x$1 !== null)) {
        var k = $as_T(x$1.$$und1$f);
        var v = $as_Lcalculator_Signal(x$1.$$und2$f);
        var this$6 = $as_sci_Map(result$1.elem$1);
        $m_Lcalculator_Signal$();
        var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this$1, v$1, namedExpressions$1$1) {
          return (function() {
            return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(v$1.apply__O()), namedExpressions$1$1)
          })
        })(this$2$1, v, namedExpressions$1));
        var y = new $c_Lcalculator_Signal().init___F0(expr);
        result$1.elem$1 = $as_sci_Map(this$6.updated__O__O__sci_MapOps(k, y))
      } else {
        throw new $c_s_MatchError().init___O(x$1)
      }
    })
  })(this, result, namedExpressions));
  this$7.filtered__sc_Iterable().foreach__F1__V(f);
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, delta$2$1, b$1, a$1) {
    return (function() {
      var this$1 = $m_s_Predef$().Set$3;
      var elems = $m_sci_Nil$();
      var result = this$1.from__sc_IterableOnce__sci_Set(elems);
      if (($uD(delta$2$1.apply__O()) >= 0)) {
        var this$3 = result;
        var jsx$1 = $uD(b$1.apply__O());
        var a$2 = $uD(delta$2$1.apply__O());
        var elem = (((-jsx$1) + $uD($g.Math.sqrt(a$2))) / (2 * $uD(a$1.apply__O())));
        result = $as_sci_Set(this$3.incl__O__sci_SetOps(elem));
        var this$5 = result;
        var jsx$2 = $uD(b$1.apply__O());
        var a$3 = $uD(delta$2$1.apply__O());
        var elem$1 = (((-jsx$2) - $uD($g.Math.sqrt(a$3))) / (2 * $uD(a$1.apply__O())));
        result = $as_sci_Set(this$5.incl__O__sci_SetOps(elem$1))
      };
      return result
    })
  })(this, delta$2, b, a));
